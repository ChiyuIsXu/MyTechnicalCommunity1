      ...
      <div class="hot-item-header">
        <div class="hot-title">
          <img
            ...
            class="hot-icon"
          />
          <span title="文章榜" class="title-text"> 推荐话题 </span>
        </div>
...
<script lang="ts" setup name="HostList">
//icons
...
// components
import HotItem from "@/components/MainContainer/IndexAside/HotList/HotItem/HotItem.vue";
</script>

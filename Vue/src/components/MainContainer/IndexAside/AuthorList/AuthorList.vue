  ...
  <div class="hot-list-container">
    <div class="hot-list-item">
      <div class="hot-item-header">
        <div class="hot-title">
          <img
            ...
            class="hot-icon"
          />
          <span title="文章榜" class="title-text"> 作者榜 </span>
        </div>
      ...
      <ul class="hot-item-body">
        <div class="skeleton">
          <el-empty :image-size="200" description="WIP"/>
        </div>
      </ul>
      ...
      <div class="hot-item-footer">
        <a href="/test-page/index.html" class="item-footer-button" target="_self">
          <span>查看更多</span> <More
        /></a>
      </div>
    </div>
...
<script lang="ts" setup name="AuthorList">
//icons
import Refresh from "@/components/MainContainer/IndexAside/HotList/assets/icons/Refresh.vue";
import More from "@/components/MainContainer/IndexAside/HotList/assets/icons/More.vue";

// components
import AuthorListItem from "@/components/MainContainer/IndexAside/AuthorList/AuthorListItem/AuthorListItem.vue";
</script>

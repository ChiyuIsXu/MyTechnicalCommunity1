...
<template>
  <div class="drop-down-menu light-shadow">
    <div class="user-card">
      <div class="user-info">
        <div class="avatar">
    ...
    <ul class="dropdown-list">
      <li class="dropdown-item">
        ...
        <a href="/user/2966895451712867" class="open-menu-page"
          ><span class="menu-icon menu-icon-light"
            ...
            >
              ...
              ></circle>
              <path
                d="M12.176 11.8125H7.82554C5.0224 11.8125 2.75 14.0849 2.75 16.888C2.75 17.5888 3.3181 18.1569 4.01889 18.1569H15.9827C16.6834 18.1569 17.2515 17.5888 17.2515 16.888C17.2515 14.0849 14.9792 11.8125 12.176 11.8125Z"
                stroke="currentColor"
                stroke-width="1.2"
                stroke-linecap="round"
              ></path></svg
          ></span>
          <span class="menu-name">我的主页</span></a
        >
      </li>
      <li class="dropdown-item">
        <a href="/test-page/index.html" class="open-menu-page"
          ><span class="menu-icon menu-icon-light"
            ><svg
              width="20"
              height="20"
            ...
            >
              <path
                d="M3.75 9.30322H16.25V16.5945C16.25 17.4229 15.5784 18.0945 14.75 18.0945H5.25C4.42157 18.0945 3.75 17.4229 3.75 16.5945V9.30322Z"
                stroke="currentColor"
                stroke-width="1.2"
              ></path>
              <rect
              ...
              ></rect>
              <path
                d="M10 4.80518L10 17.6233"
                stroke="currentColor"
                stroke-width="1.2"
              ></path>
              <path
                d="M12.241 2.30769L12.6272 2.76689V2.76689L12.241 2.30769ZM14.6603 2.57337L15.137 2.20892L15.137 2.20892L14.6603 2.57337ZM9.32129 4.76318L8.9351 4.30398L7.67566 5.36318H9.32129V4.76318ZM14.6975 4.76318V5.36318H15.0096L15.1888 5.10755L14.6975 4.76318ZM12.6272 2.76689C13.1101 2.36072 13.8004 2.43652 14.1837 2.93782L15.137 2.20892C14.3378 1.16378 12.8617 1.00168 11.8548 1.8485L12.6272 2.76689ZM9.70747 5.22237L12.6272 2.76689L11.8548 1.8485L8.9351 4.30398L9.70747 5.22237ZM9.32129 5.36318H14.6975V4.16318H9.32129V5.36318ZM14.1837 2.93782C14.5129 3.3683 14.5132 3.98065 14.2061 4.41881L15.1888 5.10755C15.7839 4.25852 15.7967 3.07181 15.137 2.20892L14.1837 2.93782Z"
                fill="currentColor"
              ></path>
              <path
                d="M7.62227 2.30769L7.23609 2.76689V2.76689L7.62227 2.30769ZM5.20295 2.57337L4.72632 2.20892L4.72632 2.20892L5.20295 2.57337ZM10.542 4.76318L10.9282 4.30398L12.1876 5.36318H10.542V4.76318ZM5.16581 4.76318V5.36318H4.85364L4.67447 5.10755L5.16581 4.76318ZM7.23609 2.76689C6.75313 2.36072 6.06288 2.43652 5.67958 2.93782L4.72632 2.20892C5.52546 1.16378 7.00155 1.00168 8.00846 1.8485L7.23609 2.76689ZM10.1558 5.22237L7.23609 2.76689L8.00846 1.8485L10.9282 4.30398L10.1558 5.22237ZM10.542 5.36318H5.16581V4.16318H10.542V5.36318ZM5.67958 2.93782C5.35042 3.3683 5.35004 3.98065 5.65714 4.41881L4.67447 5.10755C4.0794 4.25852 4.06653 3.07181 4.72632 2.20892L5.67958 2.93782Z"
                fill="currentColor"
              ></path></svg
          ></span>
          <span class="menu-name">成长福利</span></a
        >
      </li>
      <li class="dropdown-item">
        <a href="/test-page/index.html" class="open-menu-page"
          ><span class="menu-icon badge menu-icon-light"
            ...
            >
              ...
              ></rect>
              <path
                d="M7.45052 10.8334C7.45722 10.6305 7.54084 10.4377 7.68441 10.2941L10.8488 7.12981C11.2394 6.7393 11.8725 6.73931 12.263 7.12983L13.0134 7.88015C13.4039 8.27068 13.4039 8.90385 13.0134 9.29438L9.84893 12.4587C9.70537 12.6022 9.5126 12.6858 9.30968 12.6925L8.02763 12.7349C7.68085 12.7464 7.39667 12.4622 7.40813 12.1154L7.45052 10.8334Z"
                stroke="#8A919F"
                stroke-width="1.2"
              ></path>
              <path
                d="M2.30859 6.14648H4.61629"
                stroke="#8A919F"
                stroke-width="1.2"
                stroke-linecap="round"
              ></path>
              <path
                d="M2.30859 9.99219H4.61629"
                stroke="#8A919F"
                stroke-width="1.2"
                stroke-linecap="round"
              ></path>
              <path
                d="M2.30859 13.8389H4.61629"
                stroke="#8A919F"
                stroke-width="1.2"
                stroke-linecap="round"
              ></path></svg
          ></span>
          <span class="menu-name">闪念笔记</span></a
        >
      </li>
      <li class="dropdown-item">
        <a href="/test-page/index.html" class="open-menu-page"
          ><span class="menu-icon menu-icon-light"
            ...
            >
              <path
                d="M8.48696 16.866L11.7141 16.866L18.5 7.5181L15.7187 5.10263L10.0447 12.6364L4.27982 5.10263L1.55487 7.5181L8.48696 16.866Z"
                stroke="#8A919F"
                stroke-width="1.2"
              ...
              ></path>
              <path
                d="M6.5625 3.06445L10 7.54883L13.4062 3.06445"
                stroke="#8A919F"
                stroke-width="1.2"
                stroke-linecap="round"
                stroke-linejoin="round"
              ></path></svg
          ></span>
          <span class="menu-name">会员中心</span></a
        >
      </li>
      <li class="dropdown-item">
        <a href="/test-page/index.html" class="open-menu-page"
          ><span class="menu-icon menu-icon-light"
            ...
            >
              <path
                d="M4.62218 2.68165C3.64897 2.29236 2.59033 3.0091 2.59033 4.05728V13.961C2.59033 14.2639 2.77476 14.5363 3.05601 14.6488L8.88416 16.98C9.59939 17.2661 10.3973 17.2661 11.1125 16.98L16.9406 14.6488C17.2219 14.5363 17.4063 14.2639 17.4063 13.961V4.05728C17.4063 3.0091 16.3477 2.29236 15.3745 2.68165L11.1125 4.38644C10.3973 4.67253 9.59939 4.67253 8.88416 4.38644L4.62218 2.68165Z"
                stroke="currentColor"
                stroke-width="1.2"
              ></path>
              <path
                d="M9.99609 7.42676V14.094"
                stroke="currentColor"
                stroke-width="1.2"
                stroke-linecap="round"
              ></path></svg
          ></span>
          <span class="menu-name">课程中心</span></a
        >
      </li>
      <li class="dropdown-item">
        <a href="/test-page/index.html" class="open-menu-page"
          ><span class="menu-icon menu-icon-light"
            ...
            >
              ...
              ></line></svg
          ></span>
          <span class="menu-name">我的优惠</span></a
        >
      </li>
      <li class="dropdown-item">
        <a href="/test-page/index.html" class="open-menu-page"
          ><span class="menu-icon menu-icon-light"
            ...
            >
              ...
              ></line></svg
          ></span>
          <span class="menu-name">我的报名</span></a
        >
      </li>
      <li class="dropdown-item">
        <a href="/test-page/index.html" class="open-menu-page"
          ><span class="menu-icon menu-icon-light"
            ...
            >
              <path
                d="M12.7008 10.75L12.7008 13.1692C12.7008 14.3564 13.6632 15.3188 14.8504 15.3188V15.3188C16.0376 15.3188 17 14.3564 17 13.1692L17 10.75"
                stroke="#8A919F"
                stroke-width="1.2"
              ></path>
              <path
                d="M11.3201 5.39275C11.3201 3.50114 12.7118 1.89774 14.5846 1.6317V1.6317C14.7618 1.60653 14.9417 1.60653 15.1189 1.6317V1.6317C16.9917 1.89774 18.3834 3.50114 18.3834 5.39275V9.67128C18.3834 10.4747 17.7321 11.126 16.9287 11.126H12.7747C11.9714 11.126 11.3201 10.4747 11.3201 9.67128V5.39275Z"
                stroke="#8A919F"
                stroke-width="1.2"
              ></path>
              <path
                d="M11.3203 8.14209H18.3834"
                stroke="#8A919F"
                stroke-width="1.2"
              ></path>
              <path
                d="M3.01326 14L3.01326 16.4192C3.01326 17.6064 3.97568 18.5688 5.16288 18.5688V18.5688C6.35008 18.5688 7.3125 17.6064 7.3125 16.4192L7.3125 14"
                stroke="#8A919F"
                stroke-width="1.2"
              ></path>
              <path
                d="M1.63257 8.64275C1.63257 6.75114 3.02429 5.14774 4.8971 4.8817V4.8817C5.0743 4.85653 5.25417 4.85653 5.43138 4.8817V4.8817C7.30419 5.14774 8.6959 6.75114 8.6959 8.64275V12.9213C8.6959 13.7247 8.04462 14.376 7.24122 14.376H3.08725C2.28385 14.376 1.63257 13.7247 1.63257 12.9213V8.64275Z"
                stroke="#8A919F"
                stroke-width="1.2"
              ></path>
              <path
                d="M1.63281 11.3921H8.69586"
                stroke="#8A919F"
                stroke-width="1.2"
              ></path></svg
          ></span>
          <span class="menu-name">我的足迹</span></a
        >
      </li>
    </ul>
    <div class="group">
      <!-- TODO -->
      <a href="/test-page/index.html" class="setting"> 我的设置 </a>
...
.dropdown-list {
  ...
  .dropdown-item .menu-icon.badge:before {
  ...
  .dropdown-item .open-menu-page .menu-icon {
    position: relative;
    margin: 0 8px;
    height: 20px;
    width: 20px;
  ...
  .dropdown-item .open-menu-page .menu-icon svg {
    width: 100%;
    height: 100%;
  }

  .dropdown-item .open-menu-page .menu-icon-light {
    color: #8a919f;
  }

  .dropdown-item .open-menu-page .menu-name {
    display: inline-block;
  }
}
